...
const marikaSparkleTop: PartComponent = () => (
  <g transform="translate(50, 95)">
    <path d="M-38 5 Q -42 15, -45 40 H 45 Q 42 15, 38 5 L 15 -8 Q 0 -4, -15 -8 Z" fill="#0a0a0a" stroke="black" strokeWidth="2" />
...
const marikaBlackTurtleneck: PartComponent = () => (
  <g transform="translate(50, 95)">
    <path
...
const marikaLeatherJacket: PartComponent = () => (
  <g transform="translate(50, 95)">
...
const marikaOfficialJacket: PartComponent = () => (
  <g transform="translate(50, 95)">
...
const marikaAtelier: PartComponent = () => (
  <g transform="translate(50, 95)">
    ...
    <path d="M -16 -12 Q 0 -6, 16 -12 L 18 20 Q 0 28, -18 20 Z" fill="url(#goldMeshDenser)" stroke="#B45309" strokeWidth="0.5" />
...
export const MarikaBodies: PartRegistry<MarikaBodyId> = {
  marikaSparkleTop: { component: marikaSparkleTop, label: "Marika Sparkle Top", presetOnly: true, isExclusive: true },
  marikaBlackTurtleneck: {
    component: marikaBlackTurtleneck,
    label: "Marika Turtleneck",
    presetOnly: true,
    isExclusive: true,
  },
  marikaLeatherJacket: {
    component: marikaLeatherJacket,
    label: "Marika Leather Jacket",
    presetOnly: true,
    isExclusive: true,
  },
  marikaOfficialJacket: {
    component: marikaOfficialJacket,
    label: "Marika Official Jacket",
    presetOnly: true,
    isExclusive: true,
  },
