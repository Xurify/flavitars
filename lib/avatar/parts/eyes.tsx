...
const standardEyes: PartComponent = () => (
  <g>
...
const lashesEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const almondEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const wingedLashesEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
      <circle r="4.5" fill="currentColor" />
      <circle cx="2" cy="-2" r="1.8" fill="white" />
...
const blueWingedEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const lightHazelEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const brightBlueGlamEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
      <circle r="4.5" fill="#3B82F6" />
      <circle r="2.2" fill="#1e293b" />
...
const brownAlmondEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const greenLavenderGlamEyes: PartComponent = () => (
  <g>
...
const softBlueGreyEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const brightBlueNaturalEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const heavyLashesEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
      <circle r="4.5" fill="currentColor" />
      <circle cx="2" cy="-2" r="1.8" fill="white" />
...
const glamGreyEyes: PartComponent = () => (
  <g>
...
const wingedGlamEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const blueGreyGlamEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const warmBrownNaturalEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const warmBrownSoftEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const happyBrownFeminineEyes: PartComponent = () => (
  <g>
...
const blueGreyNaturalEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const hazelGreenNaturalEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const aquaBlueNaturalEyes: PartComponent = () => (
  <g>
    <g transform="translate(35, 45)">
...
const calmBlueGreyEyes: PartComponent = () => (
  <g>
...
export const Eyes: PartRegistry<EyesId> = {
  standard: { component: standardEyes, label: "Standard" },
  almond: { component: almondEyes, label: "Almond" },
  brownAlmond: { component: brownAlmondEyes, label: "Brown Almond" },
  warmBrownNatural: { component: warmBrownNaturalEyes, label: "Warm Brown Natural" },
  warmBrownSoft: { component: warmBrownSoftEyes, label: "Warm Brown Soft" },
  blueGreyNatural: { component: blueGreyNaturalEyes, label: "Blue Grey Natural" },
  hazelGreenNatural: { component: hazelGreenNaturalEyes, label: "Hazel Green Natural" },
  aquaBlueNatural: { component: aquaBlueNaturalEyes, label: "Aqua Blue Natural" },
  calmBlueGrey: { component: calmBlueGreyEyes, label: "Calm Blue Grey" },
  softBlueGrey: { component: softBlueGreyEyes, label: "Soft Blue Grey" },
  brightBlueNatural: { component: brightBlueNaturalEyes, label: "Bright Blue Natural" },
  lashes: { component: lashesEyes, label: "Lashes" },
  heavyLashes: { component: heavyLashesEyes, label: "Heavy Lashes" },
  wingedLashes: { component: wingedLashesEyes, label: "Winged Lashes" },
  wingedGlamEyes: { component: wingedGlamEyes, label: "Winged Glam" },
  glamGreyEyes: { component: glamGreyEyes, label: "Glam Grey" },
  blueGreyGlam: { component: blueGreyGlamEyes, label: "Blue Grey Glam" },
  lightHazel: { component: lightHazelEyes, label: "Light Hazel" },
  brightBlueGlam: { component: brightBlueGlamEyes, label: "Bright Blue Glam" },
  greenLavenderGlam: { component: greenLavenderGlamEyes, label: "Green Lavender Glam" },
  blueWinged: { component: blueWingedEyes, label: "Blue Winged" },
  happyBrownFeminine: { component: happyBrownFeminineEyes, label: "Happy Brown Feminine" },
  winking: { component: winkingEyes, label: "Winking" },
  tired: { component: tiredEyes, label: "Tired" },
};
