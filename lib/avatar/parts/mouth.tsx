...
const smileMouth: PartComponent = () => (
...
const neutralMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const smileDimplesMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const lipstickMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const softMatteMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const softMatteSmileMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const naturalNudeMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const naturalPinkSmileMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const glossyMauveLipsMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const laughingMouth: PartComponent = () => (
...
const neutralFullLipsMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const vibrantRedFullMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const brightGrinMouth: PartComponent = () => (
...
const softTeethSmileMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
const vibrantRedSmallMouth: PartComponent = () => (
  <g transform="translate(50, 78)">
...
export const Mouths: PartRegistry<MouthId> = {
  neutral: { component: neutralMouth, label: "Neutral" },
  smile: { component: smileMouth, label: "Smile" },
  smileDimples: { component: smileDimplesMouth, label: "Smile with Dimples" },
  softTeethSmile: { component: softTeethSmileMouth, label: "Soft Teeth Smile" },
  brightGrin: { component: brightGrinMouth, label: "Bright Grin" },
  laughing: { component: laughingMouth, label: "Laughing" },
  neutralFullLips: { component: neutralFullLipsMouth, label: "Neutral Full Lips" },
  naturalNude: { component: naturalNudeMouth, label: "Natural Nude" },
  naturalPinkSmile: { component: naturalPinkSmileMouth, label: "Natural Pink Smile" },
  lipstickMouth: { component: lipstickMouth, label: "Lipstick" },
  softMatte: { component: softMatteMouth, label: "Soft Matte" },
  softMatteSmile: { component: softMatteSmileMouth, label: "Soft Matte Smile" },
  glossyMauveLips: { component: glossyMauveLipsMouth, label: "Glossy Mauve" },
  vibrantRedFull: { component: vibrantRedFullMouth, label: "Vibrant Red Full" },
  vibrantRedSmall: { component: vibrantRedSmallMouth, label: "Vibrant Red Small" },
  smirk: { component: smirkMouth, label: "Smirk" },
  smirkRed: { component: smirkRedMouth, label: "Smirk Red" },
  pout: { component: poutMouth, label: "Pout" },
