...
const hoops: PartComponent = ({ headId }) => (
  <g>
...
const chunkyHoops: PartComponent = ({ headId }) => (
  <g>
...
const goldDropEarrings: PartComponent = ({ headId }) => (
  <g>
    <g transform={getHeadSideTransform(headId, true)}>
      {/* Simple Gold Drop */}
...
const pinkDropEarrings: PartComponent = ({ headId }) => (
  <g>
    <g transform={getHeadSideTransform(headId, true)}>
...
const pearlNecklace: PartComponent = () => (
...
const pearlEarrings: PartComponent = ({ headId }) => (
  <g>
    <g transform={getHeadSideTransform(headId, true)}>
...
const diamondStuds: PartComponent = ({ headId }) => (
  <g>
    <g transform={getHeadSideTransform(headId, true)}>
...
const layeredSilverChains: PartComponent = () => (
  <g transform="translate(50, 95)">
    {/* Top tight chain */}
...
const silverNecklace: PartComponent = () => (
  <g transform="translate(50, 95)">
    {/* Silver Chain */}
...
const goldNecklace: PartComponent = () => (
  <g transform="translate(50, 95)">
    {/* Gold Chain */}
...
const goldHexHoops: PartComponent = ({ headId }) => (
  <g>
...
const goldHoopSingle: PartComponent = ({ headId }) => (
  <g>
