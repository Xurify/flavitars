...
export const HAIR_PATHS: Record<HairId, HairPathEntry> = {
  ...
  largeAfro: {
    ...
    back: {
      ...
      hat: "M 6 36 C 4 18, 20 10, 34 26 C 20 38, 14 54, 16 74 C 20 94, 36 104, 50 92 C 36 86, 24 70, 26 48 C 28 36, 16 38, 6 36 Z M 94 36 C 96 18, 80 10, 66 26 C 80 38, 86 54, 84 74 C 80 94, 64 104, 50 92 C 64 86, 76 70, 74 48 C 72 36, 84 38, 94 36 Z M 22 78 C 28 98, 42 106, 50 106 C 58 106, 72 98, 78 78 C 70 92, 58 98, 50 98 C 42 98, 30 92, 22 78 Z",
    },
  },
  spikyMohawk: {
    front: {
      noHat: "M 22 28 L 15 15 L 30 22 L 35 6 L 45 18 L 50 -2 L 55 18 L 65 6 L 70 22 L 85 15 L 78 28 Q 50 24, 22 28 Z",
      hat: "M 28 28 L 32 20 L 40 26 L 50 18 L 60 26 L 68 20 L 72 28 Q 50 32, 28 28 Z",
    },
    back: "",
  },
  aviatorFlaps: {
