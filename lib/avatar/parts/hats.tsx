...
import { PartRegistry, PartComponent, PartDefinition } from "./common";
...
const beanie: PartComponent = ({ fill, headId, hatId }) => (
...
const baseballCap: PartComponent = ({ fill, headId, hatId }) => (
...
const bucketHat: PartComponent = ({ fill, headId, hatId }) => (
...
const cowboyHat: PartComponent = ({ fill, headId, hatId }) => (
...
cowboyHat.colors = ["brown", "black", "orange", "khaki"];

const beret: PartComponent = ({ fill, headId, hatId }) => (
...
const crown: PartComponent = ({ headId, hatId }) => (
...
const wizardHat: PartComponent = ({ fill, headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, 2, 1.1)}>
    {/* Main hat cone */}
...
const vikingHelmet: PartComponent = ({ fill, headId, hatId }) => (
...
const astronautHelmet: PartComponent = ({ headId, hatId }) => (
...
const halo: PartComponent = ({ headId, hatId }) => (
...
const propellerHat: PartComponent = ({ headId, hatId }) => (
...
const chefHat: PartComponent = ({ headId, hatId }) => (
...
const pirateHat: PartComponent = ({ fill, headId, hatId }) => (
...
pirateHat.colors = ["black", "orange", "red", "purple", "green", "pink", "blue"];

const samuraiHelmet: PartComponent = ({ headId, hatId }) => (
...
samuraiHelmet.colors = ["red", "black"];

const topHat: PartComponent = ({ fill, headId, hatId }) => (
...
const detectiveHat: PartComponent = ({ headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, 0, 1.1)}>
...
detectiveHat.colors = ["brown", "black", "khaki"];

const strawHat: PartComponent = ({ headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, -10, 1.1)}>
...
strawHat.colors = ["blonde", "khaki", "white"];

const nurseCap: PartComponent = ({ headId, hatId }) => (
...
const militaryHelmet: PartComponent = ({ fill, headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, 0, 1.1)}>
...
const ushanka: PartComponent = ({ fill, headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, 0, 1.1)}>
...
const skiMask: PartComponent = ({ fill, headId }) => {
...
const patternedHeadband: PartComponent = ({ fill, headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, 0, 1.1)}>
...
const brandedFittedCap: PartComponent = ({ headId, hatId }) => (
...
const plainBlackHeadband: PartComponent = ({ headId, hatId }) => (
  <g transform={getHeadHatTransform(headId, hatId, 0, 1.1)}>
...
export const Hats: PartRegistry<HatId> = {
  ...
  brandedFittedCap: { component: brandedFittedCap, label: "Branded Fitted Cap" },
  plainBlackHeadband: { component: plainBlackHeadband, label: "Plain Black Headband" },
  patternedHeadband: { component: patternedHeadband, label: "Patterned Headband" },
  cowboyHat: { component: cowboyHat, label: "Cowboy Hat" },
  detectiveHat: { component: detectiveHat, label: "Detective Hat" },
  ...
  pirateHat: { component: pirateHat, label: "Pirate Hat" },
  vikingHelmet: { component: vikingHelmet, label: "Viking Helmet" },
  samuraiHelmet: { component: samuraiHelmet, label: "Samurai Helmet" },
  ...
  strawHat: { component: strawHat, label: "Straw Hat" },
