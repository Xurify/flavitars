        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-[10px] text-zinc-400 font-sans shadow-sm">Ctrl</kbd>
              <span className="text-zinc-600 text-[10px]">+</span>
              <kbd className="px-1.5 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-[10px] text-zinc-400 font-sans shadow-sm">Z</kbd>
            </div>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-[10px] text-zinc-400 font-sans shadow-sm">Ctrl</kbd>
              <span className="text-zinc-600 text-[10px]">+</span>
              <kbd className="px-1.5 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-[10px] text-zinc-400 font-sans shadow-sm">Y</kbd>
            </div>
          </div>
        </div>
      </div>
